...
class AssetBuyLst extends Component {
    ...
    render() {
        ...
        <tbody>
          ...
          <td>
                ...
                onClick={this.props.removetobuylstAsset.bind(this, assetObj)}>
                    Remove from AssetBuyLst
                </button>      
            </td>
          </tr>
        </tbody>
...
export default connect(mapStatetoProps,{getAssets})(AssetBuyLst)